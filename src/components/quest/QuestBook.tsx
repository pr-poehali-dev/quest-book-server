...
const QuestCard = ({ quest, onClick, index }: { quest: Quest; onClick: (q: Quest) => void; index: number }) => {
  ...
  return (
    <div
      className={`quest-card parchment-bg rounded border p-3 animate-stagger-in ${status === "locked" ? "locked" : ""} ${status === "completed" ? "completed" : ""} ${status === "active" ? "quest-active" : ""} ${rarityClass}`}
...
const QuestModal = ({ quest, onClose }: { quest: Quest; onClose: () => void }) => {
  const rarityColors = { common: "var(--quest-gold)", rare: "210 80% 65%", epic: "270 70% 70%" };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-modal-backdrop" onClick={onClose}>
      ...
      <div className="relative w-full max-w-md parchment-bg rounded-lg border corner-decor animate-modal-reveal modal-particles p-6 overflow-hidden"
        ...
        <div className="parchment-bg rounded p-3 mb-4 border relative overflow-hidden" style={{ borderColor: "hsl(var(--quest-gold) / 0.2)" }}>
        ...
        {quest.status === "completed" && (
          <div className="rounded p-3 mb-4 text-center border animate-fade-in" style={{ borderColor: "hsl(var(--quest-green) / 0.4)", background: "hsl(var(--quest-green) / 0.1)" }}>
        ...
        {quest.status === "active" && (
          <div className="rounded p-3 mb-4 text-center border animate-fade-in" style={{ borderColor: "hsl(var(--quest-gold) / 0.3)", background: "hsl(var(--quest-gold) / 0.08)" }}>
      ...
      <header className="border-b sticky top-0 z-40 header-glow-line"
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between relative z-10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded flex items-center justify-center relative"
              style={{ background: "hsl(var(--quest-brown))", border: "1px solid hsl(var(--quest-gold) / 0.3)", boxShadow: "0 0 12px hsl(var(--quest-gold) / 0.1)" }}>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden sm:flex items-center gap-2 px-2.5 py-1 rounded relative overflow-hidden" style={{ background: "hsl(var(--muted))" }}>
          ...
          <>
              ...
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 rounded flex items-center justify-center transition-all duration-300"
                  style={{
                    ...
                    border: `1px solid ${activeBranch.color}44`,
                    boxShadow: `0 0 15px ${activeBranch.color}15`
                  }}>
            ...
            {branchQuestsWithStatus.length > 0 && (
              <div className="mt-6 flex items-center justify-center gap-3 opacity-30">
                ...
                <Icon name="Feather" size={12} color="hsl(var(--quest-gold))" className="animate-flicker" />
